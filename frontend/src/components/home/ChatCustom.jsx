...
export default function ChatCustom() {
  ...
  return (
    <div className={`${isChatVisible ? 'flex flex-col' : 'hidden'} w-full rounded-lg border-2 border-azul justify-end h-[calc(90vh-2.7rem)]`}>
      {ChatIds.current ? (
        <>
        ...
        <div className="p-4 h-full bg-gray-800 flex justify-center items-center">
          <div className="text-white">
            ...
            {/* todo check stilo modo oscuro */}
            {isButtonVisible && (
            <button
              aria-label="Toggle sidebar"
              onClick={handleHideAside}
              className=' flex items-center justify-center px-3 py-2 text-sm text-gray-700 transition-colors duration-200 bg-blanco border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-azul-100 dark:text-gray-200 dark:border-gray-700'>
