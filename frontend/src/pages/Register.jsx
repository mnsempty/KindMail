                ...
                <div className="bg-azul rounded-2xl shadow-2xl flex w-full max-w-4xl">
                    <div className="w-full p-5">
                        ...
                        <div className="bg-gray-100 w-96 p-2 flex items-center rounded-md mb-3">
                                ...
                                <input type="text" name="name" placeholder="Nombre" className="bg-gray-100 outline-none text-sm flex-1"></input>
                            </div>
                            <div className="bg-gray-100 w-96 p-2 flex items-center rounded-md mb-3">
                        ...
                        <a href="#" className="border-2 border-blanco text-blanco rounded-full px-12 py-2 inline-block font-semibold hover:bg-azulclaro hover:text-azul mb-10">Enviar</a>
                    </div>
                </div>
            </div>
        </>
