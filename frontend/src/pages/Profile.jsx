...
const Profile = () => {
    return (
        <>
            <div className="bg-azul grid grid-rows-2 md:grid-rows-2 gap-20 rounded-lg p-5">
                ...
                <div className="container flex justify-center md:justify-end">
                    <button
                        className="w-50 h-20 border-2 border-blanco text-blanco rounded-full px-12 py-2 inline-block font-semibold hover:bg-azulclaro hover:text-azul mb-10"
                    >
                        Cambiar datos
                    </button>
                </div>
